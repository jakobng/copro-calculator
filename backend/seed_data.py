...
incentives = [
    ...
    inc(
        ...
        application_note="Impact is open on a rolling basis; Discovery is closed and next runs 1-30 July 2026, then 12 November-16 December 2026.",
    ...
    inc(
        ...
        application_note="As of 7 April 2026, the legacy features guidelines remain public, but the new BFI Doc Society Fund strands are still awaiting their Spring 2026 reopening announcement.",
        source_url="https://bfi.docsociety.org/static/files/bfi/BFIDocSocietyFeatures_Guidelines.pdf",
        source_description="BFI Doc Society Features Fund guidelines and 2026 relaunch page",
        notes="Current UK documentary funding partnership between BFI and Doc Society. "
              ...
              "The currently published feature guidelines allow requests of up to GBP 150,000 toward a feature documentary or immersive non-fiction project and require British certification or official co-production eligibility.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    ...
    inc(
        ...
        operator_type="government",
        application_status="closed",
        application_note="Official 2026 AFS levy dates are 11 May 2026, 21 September 2026, and 7 December 2026.",
        source_url="https://filmfund.lu/en/funding/afs/",
        source_description="Film Fund Luxembourg — Selective Financial Assistance (AFS) and official selection calendar",
    ...
    inc(
        ...
        operator_type="government",
        application_status="rolling",
        application_note="Rolling applications; submit no later than 12 weeks before pre-production and allow up to 10 weeks for a decision.",
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="rolling",
        application_note="No strict deadlines; ACW production funding is fully allocated through April 2026, while Creative Wales-backed production support remains available.",
    ...
    inc(
        ...
        operator_type="government",
        application_status="rolling",
        application_note="Start with Northern Ireland Screen's production team; projects need at least 65% finance in place before submission.",
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="rolling",
        application_note="Start with an expression of interest; full applications are assessed once private match finance is in place.",
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="rolling",
        application_note="Applications are generally taken on a rolling basis after an initial enquiry to WRAP.",
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2025 Qatari Film Fund cycle ran from 26 January 2025 to 13 February 2025; the next cycle has not yet been announced.",
        source_url="https://www.dohafilm.com/en/funding-industry/funding/qff",
        source_description="Doha Film Institute - Qatari Film Fund page and 2025 submissions announcement",
        notes="QFF finances up to four feature films in development each year and supports up to eight short films annually across development, production and post-production. "
              "The current official pages value short-film support at up to QAR 182,500 and feature-film development support at up to QAR 182,500, with one feature developed through QFF later eligible for production funding.",
        last_verified="2026-04",
    ),
    inc(
        ...
        eligible_stages=["development", "production", "post"],
        selection_mode="selective",
        operator_type="festival",
        application_status="closed",
        application_note="The 2026 Production Fund cycle closed on 21 March 2026; the next published window is the Development Fund cycle from 6-21 May 2026.",
        source_url="https://redseafilmfest.com/en/red-sea-fund/",
        source_description="Red Sea Film Foundation - Red Sea Fund programme page and 2026 cycle calendar",
        notes="Red Sea Fund provides direct grants across development, production and post-production for eligible projects from Saudi Arabia, the Arab region, Africa, and Asia. "
              "The official FAQ states caps of up to USD 25,000 for development, up to USD 500,000 for production, and up to USD 100,000 for post-production. "
              "The programme page publishes multiple 2026 cycles by stage rather than treating support as automatic finance.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        ...
        application_status="open",
        application_note="Open call from 15 April 2026, deadline 19 June 2026, with announcement scheduled for 15 December 2026.",
        typical_award_amount=50_000,
        typical_award_currency="USD",
        source_url="https://www.arabculturefund.org/Programs/12/",
        source_description="AFAC Cinema Program open call and guidelines",
        notes="AFAC supports Arab feature-length projects in development, production and post-production, and short/medium projects in production or post-production. "
              "Current published ceilings are USD 10k for feature development, USD 50k for feature production, USD 25k for feature post-production, USD 20k for short/medium production and USD 10k for short/medium post-production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="As of 7 April 2026, the official ministry reports confirm that 2025 beneficiaries were selected and that early 2026 board sessions were preparing the next competition procedures; wait for the next published call.",
        ...
        notes="Federal ministry reporting confirms that the foundation appointed juries, reviewed recommendations, and adopted decisions selecting beneficiaries for 2025, while early 2026 board work focused on preparing the next competition procedures and programme documents.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        ...
        operator_type="foundation",
        application_status="unknown",
        application_note="The fund states there is no dedicated co-production track; co-productions apply through the regular central or debut feature production routes.",
        typical_award_amount=2_000_000,
        typical_award_currency="ILS",
        ...
        notes="Fund's main scheme invests NIS 2 million per feature; debut scheme supports up to NIS 1 million. "
              "The official co-production information page says there is no separate co-production route, but recognised co-productions can apply through the existing production tracks if they meet Israeli-film recognition rules including 50% budget spend in Israel and 70% of wage budget paid to Israeli residents.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        ...
        operator_type="government",
        application_status="open",
        application_note="The second phase opened on 28 June 2024 and supports up to eight films across two phases; confirm remaining quota with the FDC secretariat before filing.",
        source_url="https://www.fdc.gov.hk/en/eafcfs/HKEAS%20Co-production%20guide%20%28E%29_202406.pdf",
        source_description="Hong Kong-Europe-Asian Film Collaboration Funding Scheme guide to application (June 2024 version)",
    ...
    inc(
        ...
        operator_type="government",
        application_status="open",
        application_note="Scheme 2.0 is open on an ongoing basis with no published closing date.",
        ...
        notes="Launched 15 January 2025 and remains open on an ongoing basis. Government finances 40% of the approved production budget, capped at HKD 10 million per project, for qualifying productions with approved budgets up to HKD 25 million. "
              "Applicants must be Hong Kong-incorporated production companies and the scheme remains assessment-based rather than automatic.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    ...
    # -------------------------------------------------------------------------
    # INTERNATIONAL SELECTIVE FUNDS
    # -------------------------------------------------------------------------
    inc(
        name="Doha Film Institute Grants Programme",
        country_code="QA",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=100_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The Spring 2026 grants cycle opened 29 December 2025 and closed 8 January 2026; the programme normally returns with a fall cycle.",
        source_url="https://www.dohafilm.com/en/funding-industry/funding/grants",
        source_description="Doha Film Institute - Grants programme and Spring 2026 cycle dates",
        notes="DFI's biannual grants programme supports shorts, features, series and immersive work across development, production and post-production. "
              "The official feature-film guidelines say the online form opens every January and July on announced dates and list feature-grant caps of up to USD 20,000 for narrative development, USD 100,000 for narrative production, USD 75,000 for narrative post, USD 15,000 for documentary development, USD 75,000 for documentary production, and USD 50,000 for documentary post.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Hubert Bals Fund - Script and Project Development Support",
        country_code="NL",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=10_000,
        max_cap_currency="EUR",
        eligible_formats=["feature_fiction", "documentary", "animation"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="festival",
        application_status="closed",
        application_note="The 2026 Development Support deadline was 2 April 2026; the next call has not yet been announced.",
        source_url="https://iffr.com/en/hubert-bals-fund/funding-schemes/hbf-script-and-project-development-support",
        source_description="IFFR Hubert Bals Fund - Script and Project Development Support and official deadlines page",
        notes="Supports filmmakers from Africa, Asia, Latin America, the Middle East and parts of Eastern Europe with up to EUR 10,000 for script and project development. "
              "The scheme targets first and second features, with an auteur-track exception for more established directors from eligible countries.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="festival",
        application_status="closed",
        application_note="The 2026 IBF Classic call closed in February 2026; IDFA says the next deadline will be announced when confirmed and there will be no June 2026 round.",
        source_url="https://professionals.idfa.nl/training-funding/funding/ibf-classic/",
        source_description="IDFA Bertha Fund - IBF Classic",
        notes="IBF Classic supports documentary filmmakers from eligible countries in Africa, Asia, Eastern Europe, Latin America, the Caribbean and Oceania. "
              "Current guidance allows development grants up to EUR 7,500 and production or post-production grants up to EUR 25,000.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="IDFA Bertha Fund - IBF Europe Minority Co-production",
        country_code="NL",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=40_000,
        max_cap_currency="EUR",
        eligible_formats=["documentary"],
        eligible_stages=["production", "post"],
        selection_mode="selective",
        operator_type="festival",
        application_status="closed",
        application_note="The current deadline was 1 April 2026; the following published deadline is 15 January 2027.",
        source_url="https://professionals.idfa.nl/training-funding/funding/ibf-europe/",
        source_description="IDFA Bertha Fund - IBF Europe minority co-production scheme",
        notes="Supports creative documentary projects through international co-productions between at least one European minority producer and one producer from an IBF-supported country. "
              "The maximum contribution is EUR 40,000 and the ideal stage is late production or further.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        max_cap_amount=1_000_000,
        max_cap_currency="NOK",
        min_spend_percent=70.0,
        eligible_formats=["feature_fiction", "documentary"],
        eligible_stages=["production"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 Sørfond deadline was 12 March 2026 at 12:00 GMT+1; the form opens four weeks before the deadline.",
        source_url="https://www.sorfond.no/about-s%C3%B8rfond",
        source_description="Sørfond - About, criteria and 2026 deadline",
        notes="Top financing for minority co-productions between a Norwegian producer and a main producer from a DAC-eligible country. "
              "At least 50% of the budget must already be confirmed, at least 70% of the grant must be spent in eligible countries, and support is capped at NOK 1 million.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The next published 2026 dates are 13 April 2026 for post-filming support and 2 June 2026 for pre-filming support session 2.",
        source_url="https://www.cnc.fr/web/en/funds/aide-aux-cinemas-du-monde_190870",
        source_description="CNC / Institut français - Aide aux cinémas du monde",
        notes="Selective support for feature-length international co-productions involving a French production company. "
              "The current CNC page caps pre-filming support at EUR 300,000, rising to EUR 500,000 for some higher-budget French-initiated works, and caps post-filming support at EUR 70,000.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
        name="Purin Film Fund - Production Fund",
        country_code="TH",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=30_000,
        max_cap_currency="USD",
        eligible_formats=["feature_fiction", "documentary", "animation"],
        eligible_stages=["production"],
        selection_mode="selective",
        operator_type="foundation",
        application_status="closed",
        application_note="Spring 2026 submissions are closed; the next fall cycle opens 1 August 2026 and closes 1 September 2026.",
        source_url="https://www.purin.org/funds/production-fund/",
        source_description="Purin Film Fund - Production Fund regulations and timeline",
        notes="Supports Southeast Asian feature projects over 60 minutes. "
              "Fiction and animation projects can receive USD 30,000 cash, while documentaries can receive USD 15,000. "
              "The director must be a Southeast Asian citizen and the main production company must be registered in Southeast Asia.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2025 Documentary Fund deadline was 14 July 2025, and as of 7 April 2026 Sundance says the next open call will be in late spring / early summer 2026.",
        source_url="https://www.sundance.org/programs/documentary-film",
        source_description="Sundance Institute Documentary Film Program - Documentary Fund and 2025 application materials",
        notes="Worldwide non-recoupable support for independent feature documentaries. "
              "Current programme guidance prioritises projects under USD 1.2 million and offers grants up to USD 40,000 at development and up to USD 100,000 at production or post-production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Chicken & Egg Films - Research & Development Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=20_000,
        max_cap_currency="USD",
        eligible_formats=["documentary"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="foundation",
        application_status="closed",
        application_note="The 2026 Research & Development Grant closed on 4 February 2026; Chicken & Egg says the next cycle is tentatively expected to open in December 2026.",
        source_url="https://chickeneggfilms.org/programs/research-and-development-grant",
        source_description="Chicken & Egg Films - Research & Development Grant",
        notes="Supports filmmakers worldwide who have already directed at least one feature-length documentary and are developing their next feature documentary. "
              "Current official guidance offers USD 10,000 research grants and USD 20,000 development grants.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Ford Foundation JustFilms Open Call",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="As of 7 April 2026, submissions for documentary film production grants are closed; Ford does not publish a fixed next deadline on the application page.",
        source_url="https://www.fordfoundation.org/work/our-grants/justfilms/justfilms-application/",
        source_description="Ford Foundation - JustFilms Application",
        notes="Through its open call, JustFilms supports artist-driven feature-length documentary films of at least 50 minutes that intersect with Ford's social-justice mission. "
              "The application page says direct content development, production and post-production are eligible, while shorts, docuseries, impact campaigns, commissioned films without filmmaker rights control, and premiered projects are excluded.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="SFFILM Rainin Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=25_000,
        ...
        min_total_budget=0,
        eligible_formats=["feature_fiction"],
        eligible_stages=["development", "post"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="open",
        application_note="The 2026 grant opened 10 February 2026; deadlines are 8 May 2026 and 22 May 2026.",
        source_url="https://sffilm.org/rainin-grant/",
        source_description="SFFILM Rainin Grant overview and 2026 timeline",
        notes="Narrative-feature grant supporting screenwriting, development, and post-production for projects with budgets below USD 3 million that address social justice issues and benefit the Bay Area filmmaking community. "
              "Applicants can request up to USD 25,000 and the programme is open internationally.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="SFFILM Documentary Film Fund",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=20_000,
        max_cap_currency="USD",
        eligible_formats=["documentary"],
        eligible_stages=["post"],
        selection_mode="selective",
        operator_type="festival",
        application_status="open",
        application_note="The 2026 fund opened 3 March 2026; deadlines are 9 June 2026 and 7 July 2026.",
        source_url="https://sffilm.org/documentary-film-fund/",
        source_description="SFFILM Documentary Film Fund overview and 2026 timeline",
        notes="Supports feature-length documentaries in post-production from anywhere in the world. "
              "SFFILM awards approximately 3 to 4 grants each year, generally in the USD 10,000 to USD 20,000 range, and requires projects to be within about three months of beginning post-production from the final deadline.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="SFFILM Sloan Science in Cinema Filmmaker Fellowship",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=35_000,
        max_cap_currency="USD",
        eligible_formats=["feature_fiction", "series"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="open",
        application_note="The 2026 fellowship opened 10 February 2026; deadlines are 8 May 2026 and 22 May 2026.",
        source_url="https://sffilm.org/sloan-science-in-cinema-filmmaker-fellowship/",
        source_description="SFFILM Sloan Science in Cinema Filmmaker Fellowship overview and 2026 timeline",
        notes="Two projects are selected each year at the screenwriting stage. "
              "Each fellow receives a USD 35,000 cash grant, a FilmHouse residency, and access to a science advisor; eligible projects are feature fiction films or episodic series with realistic scientific or technological content at the center of the screenplay.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="SFFILM Sloan Stories of Science Development Fund",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=20_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="Applications will reopen in 2027; the fund operates every two years.",
        source_url="https://sffilm.org/sffilm-sloan-stories-of-science-development-fund/",
        source_description="SFFILM Sloan Stories of Science Development Fund overview",
        notes="Awards 2 to 4 grants of USD 10,000 to USD 20,000 to writers in the early stages of feature-fiction or episodic projects inspired by discoveries in the Stories of Science Sourcebook. "
              "Projects must be grounded in realistic scientific research; documentaries, shorts, and most speculative science-fiction stories are not eligible.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="SFFILM Cedar Road Iyagi Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=30_000,
        ...
        application_status="open",
        application_note="The 2026 grant opened 10 February 2026; deadlines are 8 May 2026 and 22 May 2026.",
        source_url="https://sffilm.org/cedar-road-iyagi-grant/",
        source_description="SFFILM Cedar Road Iyagi Grant overview and 2026 timeline",
        notes="Feature-fiction grant for stories centered on Asian and Asian American characters and experiences. "
              "Awards 1 to 2 projects each year with grants between USD 10,000 and USD 30,000 across screenwriting, development, pre-production, production, and post-production, for projects with budgets below USD 3 million.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Film Independent Sloan Distribution Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=50_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="As of 7 April 2026, Film Independent's applications page does not list the Sloan Distribution Grant among open programs; monitor the applications page for the next window.",
        source_url="https://www.filmindependent.org/programs/grants-and-awards/sloan-distribution-grant/",
        source_description="Film Independent - Sloan Distribution Grant and applications page",
        notes="A USD 50,000 grant for a narrative fiction feature entering its distribution phase. "
              "Applicants must be U.S. legal residents and the film must prominently feature science, mathematics, technology, or economics themes or characters.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="As of 7 April 2026, ITVS says Open Call is not currently accepting applications.",
        source_url="https://itvs.org/funds/open-call/",
        source_description="ITVS - Open Call",
        notes="Co-production funding for single nonfiction documentary projects in production or post-production that are over 10 minutes long and intended for public media distribution. "
              "The current official page lists up to USD 400,000 for long-form features and up to USD 50,000 for stand-alone shorts, and states that funding is provided through a co-production agreement rather than a grant.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="ITVS Development Fund",
        country_code="US",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=35_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="As of 7 April 2026, ITVS says the Development Fund is not currently accepting applications.",
        source_url="https://itvs.org/funds/development-fund/",
        source_description="ITVS - Development Fund",
        notes="Early-stage support for nonfiction documentary projects intended for public media distribution. "
              "The current official funding page lists up to USD 35,000 for projects that are 30, 60, or 90 minutes in length, plus feedback on the full funding proposal.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="ITVS Incubator Fund",
        country_code="US",
        incentive_type="fund",
        rebate_percent=None,
        typical_award_amount=10_000,
        typical_award_currency="USD",
        eligible_formats=["documentary"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="closed",
        application_note="As of 7 April 2026, ITVS lists the Incubator Fund as 'Applications Closed January 30.'",
        source_url="https://itvs.org/funds/incubator-fund/",
        source_description="ITVS - Incubator Fund",
        notes="Early-stage support for nonfiction features and web series paired with a three- to six-month incubator. "
              "The current official page says selected projects receive up to USD 10,000 in initial funding, with the possibility of additional funding up to USD 30,000.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Alter-Cine Foundation Documentary Film Grants",
        country_code="CA",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=10_000,
        ...
        operator_type="foundation",
        application_status="open",
        application_note="Applications are accepted each year by email and the 2026 deadline is 15 August 2026.",
        source_url="https://altercine.org/en/documentary-film-grants/",
        source_description="Alter-Cine Foundation - Documentary Film Grants",
        notes="Annual documentary-production grants for filmmakers born and living in Africa, Asia, or Latin America. "
              "The official programme page says the foundation awards grants of CAD 10,000 and CAD 5,000 to help produce a feature-length documentary project and requires a synopsis plus a Vimeo link to a prior documentary work.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="IDA Pare Lorentz Documentary Fund",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        typical_award_amount=25_000,
        typical_award_currency="USD",
        max_cap_amount=25_000,
        max_cap_currency="USD",
        eligible_formats=["documentary"],
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2025 nomination cycle used a migration-in-the-Americas theme, with short applications due by the end of June 2025 and grantees selected by the end of September 2025; as of 7 April 2026 no new cycle has been posted.",
        source_url="https://www.documentary.org/parelorentz",
        source_description="International Documentary Association - Pare Lorentz Documentary Fund",
        notes="IDA's oldest documentary fund supports independent feature-length documentaries that illuminate urgent issues through production and post-production support. "
              "The current official page says three projects are selected each cycle for USD 25,000 grants plus a USD 2,000 consultation stipend, and that the 2025 awards were made through nominations from key film organizations across the Americas.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="IDA Enterprise Documentary Fund",
        country_code="US",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="As of 7 April 2026, IDA states that Enterprise Documentary Fund applications are paused for the 2025 funding cycle while the program is under strategic review, and no reopened cycle has been published.",
        source_url="https://www.documentary.org/enterprise/about",
        source_description="International Documentary Association - Enterprise Documentary Fund",
        notes="Supports original documentary projects that integrate journalistic practice, including fact-checking and rigorous research, into cinematic nonfiction storytelling. "
              "IDA says the fund has expanded access beyond the United States since 2021 and currently remains under strategic review pending a new funding framework.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="As of 7 April 2026, IDA says the Logan Elevate Grant remains paused for the 2025 funding cycle while the program is under strategic review.",
        source_url="https://www.documentary.org/creators/funding/logan-elevate-grant",
        source_description="International Documentary Association - Logan Elevate Grant",
        notes="Supports emerging women and non-binary filmmakers of color directing feature-length journalistic documentaries. "
              "The current official page says IDA awards three unrestricted USD 30,000 grants per cycle, alongside story consulting and year-long professional-development support, with the programme made possible by the Jonathan Logan Family Foundation.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2026 LEF guidelines keep separate August and January deadlines: Early Development and Pre-production share the August deadline, while Production and Post-production share the January deadline.",
        source_url="https://lef-foundation.org/moving-image-fund/guidelines/",
        source_description="LEF Foundation - Moving Image Fund guidelines",
        notes="New England documentary fund with phase-specific support for independent projects demonstrating originality of vision and creativity in form. "
              "The current official guidelines publish maximum grants of USD 2,500 for Early Development, USD 5,000 for Pre-production, USD 15,000 for Production, and USD 25,000 for Post-production, with a U.S. fiscal sponsor required at grant stage.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="Jewish Story Partners accepts one annual open call each year in late fall and closes it in January; the site currently says 'Apply for funding by January 16th, 2026' and decisions are announced by early summer.",
        source_url="https://jewishstorypartners.org/guidelines/",
        source_description="Jewish Story Partners - Guidelines, FAQ, and 2026 call-to-apply page text",
        notes="Supports U.S. documentary feature films exploring some aspect of Jewish experience, with projects eligible from development through post-production so long as both a director and producer are attached and at least five minutes of footage can be submitted. "
              "The official guidelines require at least one director or producer to be based full-time in the U.S.; the public guidelines do not publish a standard per-project award cap.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
        name="Catapult Development Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=25_000,
        max_cap_currency="USD",
        eligible_formats=["documentary", "short"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="open",
        application_note="The 2026 Step 1 application opened on 23 March 2026 and closes on 20 April 2026 at 5 p.m. PT.",
        source_url="https://catapultfilmfund.org/how-to-apply/development/",
        source_description="Catapult Film Fund - Development Grant 2026 overview and guidelines",
        notes="Early-stage support for documentary features and shorts that are in development or early production and need to create a fundraising piece. "
              "The current official page says Catapult will award fifteen grants of USD 5,000 to USD 25,000 in 2026 and requires projects to have secured access, with no support for docuseries.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Catapult Research Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        typical_award_amount=10_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 Research Grant is closed; Catapult's 2026 page lists a 7 January 2026 opening, a 2 February 2026 deadline, and a Spring 2026 cohort announcement.",
        source_url="https://catapultfilmfund.org/how-to-apply/research/",
        source_description="Catapult Film Fund - Research Grant 2026 overview and guidelines",
        notes="Mentored early-conception support for U.S.-based filmmakers developing a documentary feature or short. "
              "The current official guidelines provide USD 10,000 per project and require applicants to have completed at least one publicly exhibited feature-length documentary or demonstrate comparable professional nonfiction experience.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The official 2024 Open Call submissions portal is closed; as of 7 April 2026 Black Public Media has not posted a newer feature-documentary open-call cycle on the programme page.",
        source_url="https://blackpublicmedia.org/for-media-makers/bpm-open-call/",
        source_description="Black Public Media - BPM Open Call",
        notes="Public-media licensing support for broadcast-length nonfiction projects about the global Black experience. "
              "The current programme page says the last published cycle offered five USD 5,000 stipends plus one USD 150,000 PitchBLACK award for a 60+ minute documentary project, with U.S.-citizen or green-card-holder participation and public-media rights availability required.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Firelight Media Documentary Lab",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=25_000,
        ...
        operator_type="mixed",
        application_status="open",
        application_note="The 2026 open call began on 6 April 2026 and closes on 4 May 2026 at 11:59 p.m. ET.",
        source_url="https://www.firelightmedia.tv/documentary-lab",
        source_description="Firelight Media - Documentary Lab Fellowship 2026",
        notes="Twelve-month fellowship for filmmakers of color in the United States directing their first or second feature-length documentary. "
              "The current official page says the 2026 lab only accepts films in post-production and provides a USD 25,000 project grant plus mentorship and professional-development support.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Ellis-Beauregard Foundation Documentary Film Award",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=50_000,
        ...
        operator_type="mixed",
        application_status="open",
        application_note="The 2026 submissions opened on 16 March 2026 and remain open until 16 April 2026, or until 300 applications have been received.",
        source_url="https://pointsnorthinstitute.org/artist-programs/ellis-beauregard-foundation-documentary-film-award/",
        source_description="Points North Institute / Ellis-Beauregard Foundation - Documentary Film Award 2026",
        notes="Post-production award for artist-driven feature documentaries by U.S.-based nonfiction filmmakers. "
              "The current official page says one unrestricted USD 50,000 grant is awarded each cycle, together with a Points North creative retreat for the director and editor, and prefers projects expected to be completed by Summer 2027.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The published 2025 cycle opened on 2 June 2025 and closed on 31 July 2025 at 11:59 p.m. ET; as of 7 April 2026 no new cycle is posted.",
        source_url="https://www.axsfilmfund.org/what-we-fund/",
        source_description="AXS Film Fund - What We Fund and How to Apply",
        notes="Completion support for feature-length documentary films and nonfiction new-media projects, with a focus on creators living with disabilities, especially those from underserved communities. "
              "The official site says AXS awards up to five grants of up to USD 10,000 each per cycle and accepts projects at any stage from pre-production through distribution.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Vision Maker Media Creative Shorts Fellowship",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=25_000,
        max_cap_currency="USD",
        eligible_formats=["documentary", "animation", "short"],
        eligible_stages=["production", "post"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="open",
        application_note="As of 7 April 2026, Vision Maker Media's Fund Your Film page shows the Creative Shorts Fellowship as open via an 'Apply Today' link, while the current guidelines PDF does not publish a fixed closing date.",
        source_url="https://visionmakermedia.org/wp-content/uploads/2026/03/CSF_Guidelines.pdf",
        source_description="Vision Maker Media - Creative Shorts Fellowship guidelines (2026)",
        notes="Production-to-completion support for short films by emerging Native filmmakers in documentary, drama, experimental, or animation formats. "
              "The current official guidelines allow requests of up to USD 25,000 for production costs, with a separate USD 5,000 mentor honorarium paid directly by Vision Maker Media.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Austin Film Society Grant for Feature Films",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=15_000,
        max_cap_currency="USD",
        eligible_formats=["feature_fiction", "documentary"],
        eligible_stages=["development", "production", "post"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 AFS Grant for Feature Films opens on 15 April 2026 and closes on 20 May 2026 at 6 p.m. CT.",
        source_url="https://www.austinfilm.org/afs-grants/afs-grants-applications/",
        source_description="Austin Film Society - AFS Grant applications and 2026 feature-film dates",
        notes="Annual cash grant for Texas-based filmmakers working on feature-length narrative or documentary projects of 40 minutes or more. "
              "The official application page allows requests of up to USD 15,000 for development, pre-production, production, or post-production, with in-kind grants potentially added on top of the cash request.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="North Texas Pioneer Film Award",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=15_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 North Texas Pioneer Film Award opens with the AFS feature-grant cycle on 15 April 2026 and closes on 20 May 2026 at 6 p.m. CT.",
        source_url="https://www.austinfilm.org/afs-grants/afs-grants-applications/",
        source_description="Austin Film Society - North Texas Pioneer Film Award within AFS Grant applications",
        notes="Cash award within the AFS feature-grant cycle for emerging filmmakers residing in the Dallas-Fort Worth area and surrounding region. "
              "The official page says USD 30,000 in total cash support is available, with grants ranging from USD 5,000 to USD 15,000 for first or second feature-length films by filmmakers from backgrounds traditionally underrepresented in independent film.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="AFS New Texas Voices Award",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=10_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 New Texas Voices Award opens with the AFS feature-grant cycle on 15 April 2026 and closes on 20 May 2026 at 6 p.m. CT.",
        source_url="https://www.austinfilm.org/afs-grants/afs-grants-applications/",
        source_description="Austin Film Society - New Texas Voices Award within AFS Grant applications",
        notes="Special cash award within the AFS feature-grant cycle for Texas filmmakers bringing an underseen perspective to their first feature project. "
              "The official page offers a USD 10,000 award plus specialized consultation, limited to first feature-length narrative or documentary projects in early to mid-production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="Applications for the 2026 round are closed; the deadline was Friday 30 January 2026 at 23:59 GMT, with shortlisted projects contacted at the end of April and the winners announced at Sheffield DocFest in June 2026.",
        source_url="https://www.whickerawards.com/apply/film-and-tv/",
        source_description="The Whickers - Film & TV Funding Award 2026",
        notes="International documentary award for emerging first-time feature directors making a director-led 50+ minute documentary. "
              "The official page lists a main award of GBP 120,000 and a GBP 25,000 runner-up development award, while requiring budgets not to exceed GBP 500,000 at the time of application unless the project is animated.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="TorinoFilmLab - TFL Co-Production Fund",
        country_code="IT",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=50_000,
        ...
        application_status="closed",
        application_note="The 2026 open call closed on 4 March 2026.",
        source_url="https://www.torinofilmlab.it/labs/tfl-co-production-fund",
        source_description="TorinoFilmLab - TFL Co-Production Fund 2026",
        notes="Production grant of EUR 50,000 plus consultancies for international co-productions in advanced development. "
              "Eligible projects must be over 60 minutes and structured between MEDIA-country producers holding 20-70% and non-MEDIA producers holding 30-80%.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="World Cinema Fund Classic",
        country_code="DE",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=60_000,
        max_cap_currency="EUR",
        min_total_budget=200_000,
        eligible_formats=["feature_fiction", "documentary"],
        eligible_stages=["production", "post"],
        selection_mode="selective",
        operator_type="festival",
        application_status="unknown",
        application_note="Usually two submission processes take place each year; the submission form goes live four to six weeks before each deadline.",
        source_url="https://www.berlinale.de/en/wcf/funding-programmes/production-support/wcf-classic.html",
        source_description="Berlinale World Cinema Fund - WCF Classic",
        notes="Supports feature-length fiction films and creative documentaries from WCF-eligible regions in cooperation with German production companies. "
              "Maximum support is EUR 60,000 per project and EUR 40,000 for post-production; supported production budgets should normally range from EUR 200,000 to EUR 1.4 million.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="World Cinema Fund Europe",
        country_code="DE",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=60_000,
        ...
        application_status="unknown",
        application_note="Usually two submission processes take place each year; the submission form goes live four to six weeks before each deadline.",
        source_url="https://www.berlinale.de/en/wcf/funding-programmes/production-support/wcf-europe.html",
        source_description="Berlinale World Cinema Fund - WCF Europe",
        notes="Supports feature-length fiction films and creative documentaries between WCF Europe eligible regions and companies from the Creative Europe MEDIA countries. "
              "The programme follows the same artistic-selection logic as WCF Classic and can be combined with non-MEDIA funding bodies such as TFL Co-Production Fund, Hubert Bals Fund + Europe and IDFA Bertha Fund Europe.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="2026 deadlines are 9 January, 31 March and 8 September 2026 at 12:00 noon CET; the next deadline is 8 September 2026.",
        source_url="https://www.coe.int/en/web/eurimages/deadlines",
        source_description="Council of Europe — Eurimages co-production deadlines and application timing",
        notes="Soft loan (repayable from first € of net receipts) up to €500k or 17% of total production cost. "
              "Requires official co-production between at least two member states, and at least 50% of the project financing must be confirmed in each co-producing country at the time of application. "
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 call ran from 30 January 2026 to 30 March 2026 at 11:59 a.m. local time of the lead production company.",
