...
incentives = [
    ...
    inc(
        name="European Solidarity Fund for Ukrainian Films",
        country_code="UA",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=90_000,
        max_cap_currency="EUR",
        eligible_formats=["feature_fiction", "documentary", "animation"],
        eligible_stages=["production"],
        ...
        application_note="The 2025 production call opened on 18 May 2025 and closed on 30 June 2025.",
        source_url="https://esfuf.eu/how-to-apply/",
        source_description="ESFUF - How to apply and 2025 production call",
        notes="The European Solidarity Fund for Ukrainian Films provides production support to Ukrainian feature films, including documentaries, through co-productions with European partners. "
              "The current guidelines cap documentary support at EUR 90,000 and require a Ukrainian director and a co-production with one of the contributing European territories.",
    ...
    inc(
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="New applications closed to film applications on 6 October 2025.",
        source_url="https://bfi.docsociety.org/bfi-doc-rad/",
        source_description="BFI Doc Society RAD Fund",
        notes="BFI Doc Society's research and development fund for feature-length documentary and immersive projects. "
              "The fund supports up to GBP 5,000 for first or second-time feature documentary directors or director/producer teams, or up to GBP 10,000 for producers with more than one feature documentary in early development.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="BFI Doc Society Made of Truth Short Film Fund",
        country_code="GB",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The fund is now closed and is an annual open call.",
        source_url="https://bfi.docsociety.org/bfi-doc-shorts/",
        source_description="BFI Doc Society Made of Truth Short Film Fund",
        notes="Made of Truth is BFI NETWORK's short non-fiction fund for UK-based directors. "
              "It supports up to 15 films per year with grants of up to GBP 25,000 and films between 5 and 40 minutes in length.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    ...
    inc(
        name="Norway Documentary Co-production Funding",
        country_code="NO",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="government",
        application_status="rolling",
        application_note="Documentaries are evaluated on a rolling basis with no specific deadline.",
        source_url="https://www.nfi.no/en/co-producing-with-norway/co-producing-with-norway",
        source_description="Norwegian Film Institute - Co-producing with Norway (documentaries)",
        notes="The Norwegian Film Institute offers funding for documentary productions with a Norwegian minority co-producer, with applications evaluated on a rolling basis. "
              "Support levels are determined by Norwegian spending and the share of other Norwegian investment, and the project must be acknowledged as a cultural product in the delegate producer's home country.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    ...
    # -------------------------------------------------------------------------
    inc(
        name="BFI NETWORK England short film funding",
        country_code="GB",
        region="England",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="government",
        application_status="closed",
        application_note="The 10 February 2026 round closed at 11am on 18 March 2026; the page says the next supported production window runs from 1 November 2026 to 31 October 2027.",
        source_url="https://www.bfi.org.uk/get-funding-support/bfi-network/bfi-network-england-short-film-funding",
        source_description="BFI NETWORK England short film funding",
        notes="BFI NETWORK England short film funding supports early career filmmakers and original fictional shortform projects of up to 15 minutes in live action, animation and immersive / virtual reality. "
              "The current round offers awards of GBP 5,000 to GBP 25,000 and is only open to teams with directors based in England. "
              "Applications are assessed for projects scheduled to start production in the next supported production window.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="BFI NETWORK England: Early Development Fund",
        country_code="GB",
        region="England",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=5_000,
        max_cap_currency="GBP",
        eligible_formats=["feature_fiction", "animation"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="government",
        application_status="closed",
        application_note="The current round closed at 11am on 18 November 2025.",
        source_url="https://www.bfi.org.uk/get-funding-support/bfi-network/bfi-network-funding-finder/bfi-network-england-early-development-fund",
        source_description="BFI NETWORK England: Early Development Fund",
        notes="BFI NETWORK England Early Development Fund supports writers in England at the very beginning of feature or immersive project development. "
              "Stage one awards are GBP 3,000 to GBP 5,000 to develop a treatment, and projects that complete stage one may later apply for a second stage award to complete a first draft. "
              "The fund is for debut long-form projects and can be applied to with or without a producer.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="BFI NETWORK England feature treatment funding",
        country_code="GB",
        region="England",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="government",
        application_status="closed",
        application_note="The BFI says the next funding round will launch after summer 2023 and the page is currently closed.",
        source_url="https://www.bfi.org.uk/get-funding-support/bfi-network/bfi-network-england-feature-treatment-funding",
        source_description="BFI NETWORK England feature treatment funding",
        notes="First-step development support for live action and animated fiction projects from new feature writers based in England. "
              "The current page is closed and describes the treatment stage as the entry point for writers who have not yet had a produced and distributed feature film script. "
              "Applicants may apply with or without a producer, and successful teams receive BFI NETWORK creative oversight while creating the initial treatment package.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="BFI Doc Society Short Film Fund (Made of Truth)",
        country_code="GB",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=25_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="Annual scheme; the current round is closed.",
        source_url="https://bfi.docsociety.org/bfi-doc-shorts/",
        source_description="BFI Doc Society Shorts Fund / Made of Truth",
        notes="Made of Truth is BFI Doc Society's UK-wide short documentary fund and supports original non-fiction shorts, hybrid work, artist films, essays, observational projects, VR and immersive projects rooted in non-fiction. "
              "The current fund page says it can support up to 15 projects per year with grants of up to GBP 25,000 and films between 5 and 40 minutes in length. "
              "It is aimed at emerging creatives and is part of BFI NETWORK.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Take Three: North Star Shorts",
        country_code="GB",
        region="Scotland",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2025 call closed on 26 September 2025.",
        source_url="https://www.takethree.scot/programme/north-star-shorts/",
        source_description="Take Three - North Star Shorts",
        notes="North Star Shorts is a Screen Scotland and BFI NETWORK-backed live action short fiction programme for filmmakers based in Scotland. "
              "The current page says six films are selected for development and that awards of up to GBP 25,000 are available. "
              "The scheme is aimed at filmmakers moving from documentary or animation into scripted fiction or otherwise building toward a first feature.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="Take Three: Next Wave",
        country_code="GB",
        region="Scotland",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2025 call closed at midday on 3 October 2025.",
        source_url="https://www.takethree.scot/programme/next-wave/",
        source_description="Take Three - Next Wave",
        notes="Next Wave supports three short live action fiction films developed and produced by previously funded Scottish talent, with two Screen Scotland films and one Gaelic-language film supported by MG ALBA in collaboration with Screen Scotland. "
              "The programme offers budgets of GBP 25,000 and is intended for filmmakers who have already made a previous funded short via a BFI Network scheme. "
              "The scheme is aimed at talent in Scotland looking to make a further short before moving into features.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="Take Three: The Bigger Picture",
        country_code="GB",
        region="Scotland",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2025 call closed at midday on 10 November 2025.",
        source_url="https://www.takethree.scot/programme/the-bigger-picture/",
        source_description="Take Three - The Bigger Picture",
        notes="The Bigger Picture is a Screen Scotland Take Three programme for Scotland-based filmmakers who have already made a feature or are developing a first feature with demonstrable industry interest. "
              "The current page says awards of GBP 90,000 are available and that projects must be supplemented with additional third-party finance and the UK tax credit. "
              "The scheme supports up to three live action short fiction films, with a Gaelic-language project ring-fenced in collaboration with MG ALBA.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Ffilm Cymru Wales Beacons: Short Film Funding",
        country_code="GB",
        region="Wales",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="Currently closed for applications; the latest round closed on 27 June 2025 at 12pm.",
        source_url="https://ffilmcymruwales.com/funding-and-training/beacons-short-film-funding",
        source_description="Ffilm Cymru Wales - Beacons: Short Film Funding",
        notes="Beacons is Ffilm Cymru Wales' BFI NETWORK Wales short film scheme for live action, documentary, animation and hybrid shorts up to 15 minutes in length. "
              "The current page says the fund is currently closed and that awards can be up to GBP 25,000. "
              "The scheme includes creative and practical support, training and mentoring for Welsh filmmakers.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="Ffilm Cymru Wales Feature Film Development",
        country_code="GB",
        region="Wales",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=24_999,
        max_cap_currency="GBP",
        eligible_formats=["feature_fiction", "documentary", "animation"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="closed",
        application_note="The fund is paused for the rest of the 2025-26 financial year and is due to reopen in April 2026.",
        source_url="https://ffilmcymruwales.com/funding-and-training/feature-film-development",
        source_description="Ffilm Cymru Wales - Feature Film Development",
        notes="Ffilm Cymru Wales' updated feature development fund combines the former Horizons emerging-filmmaker development strand with the established-feature development strand. "
              "The current page says small development awards can be up to GBP 10,000 and larger awards can be up to GBP 24,999. "
              "The scheme is for Wales-born or Wales-based writers, directors and producers developing live-action, documentary or animated feature films for cinema audiences.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Northern Ireland Screen New Shorts Focus",
        country_code="GB",
        region="Northern Ireland",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=12_500,
        max_cap_currency="GBP",
        eligible_formats=["feature_fiction"],
        eligible_stages=["development", "production"],
        selection_mode="selective",
        operator_type="government",
        application_status="closed",
        application_note="The 2025-26 development process ended on 29 August 2025.",
        source_url="https://northernirelandscreen.co.uk/funding/short-film-calls/new-shorts-focus-2/",
        source_description="Northern Ireland Screen - New Shorts Focus",
        notes="New Shorts Focus is Northern Ireland Screen's fiction development scheme for under-represented new and emerging Northern Ireland resident writer and writer/director talent. "
              "The scheme says up to six projects are selected for development, with up to three projects eligible to receive a production award of up to GBP 12,500. "
              "It is the only short film fiction development scheme Northern Ireland Screen currently operates.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
        name="Northern Ireland Screen Short Film Call",
        country_code="GB",
        region="Northern Ireland",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=7_500,
        max_cap_currency="GBP",
        eligible_formats=["feature_fiction", "documentary"],
        eligible_stages=["production"],
        selection_mode="selective",
        operator_type="government",
        application_status="closed",
        application_note="The 2025 short film call closed on 27 June 2025 for individual applications and 1 August 2025 for company applications.",
        source_url="https://northernirelandscreen.co.uk/funding/short-film-calls/short-film-call/",
        source_description="Northern Ireland Screen - Short Film Call",
        notes="Northern Ireland Screen's short film call is a production scheme for live action, factual and virtual reality short films normally up to 15 minutes in length. "
              "The current call supports individual awards up to GBP 2,250 and company awards up to GBP 7,500, and the fund is aimed at new and emerging Northern Ireland resident creative talent. "
              "The scheme is run in partnership with BFI NETWORK and the Arts Council of Northern Ireland lottery funding stream.",
        stacking_allowed=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Hot Docs-Blue Ice Docs Fund",
        country_code="CA",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="Please check back later for information about applying to this fund.",
        source_url="https://hotdocs.ca/industry/film-funds/hot-docs-blue-ice-docs-fund",
        source_description="Hot Docs - Hot Docs-Blue Ice Docs Fund",
        notes="Supports African documentary filmmakers with development grants of up to CAD 10,000 and production grants of up to CAD 40,000. "
              "The fund invests in 4 to 10 projects annually and also offers a mentorship pathway for up to five funded projects each year.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Hot Docs-Slaight Family Fund",
        country_code="CA",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="Applications are closed.",
        source_url="https://hotdocs.ca/industry/film-funds/hot-docs-slaight-family-fund",
        source_description="Hot Docs - Hot Docs-Slaight Family Fund",
        notes="Supports Canadian and international documentary projects focused on music artists or music stories. "
              "Hot Docs says the fund supports 3 to 5 documentary projects each year with amounts ranging from CAD 15,000 to CAD 60,000.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Hot Docs CrossCurrents Canada Doc Fund",
        country_code="CA",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="Hot Docs describes the program on its Canadian Storytellers Project page, but no current open call is posted.",
        source_url="https://hotdocs.ca/industry/professional-development/canadian-storytellers-project",
        source_description="Hot Docs Canadian Storytellers Project - CrossCurrents Canada Doc Fund",
        notes="Hot Docs' Canadian Storytellers Project says the CrossCurrents Canada Doc Fund supports 25 to 40 independent documentary projects from emerging filmmakers, with grants ranging from CAD 10,000 to CAD 50,000. "
              "The fund supports both short and feature-length projects across development, production and post-production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="National Film and Video Foundation Production and Development Funding Call",
        country_code="ZA",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=200_000,
        ...
        operator_type="government",
        application_status="closed",
        application_note="Cycle 1 funding for the 2025/2026 financial year opened on 17 February 2025 and closed on 24 March 2025; NFVF said a separate short-film documentary call would open later in the financial year.",
        source_url="https://www.nfvf.co.za/the-national-film-and-video-foundation-nfvf-production-and-development-funding-call-2/",
        source_description="NFVF - Production and Development Funding Call",
        notes="NFVF's funding FAQ says documentaries can receive up to ZAR 100,000 in development and up to ZAR 200,000 in production. "
              "The 2025/2026 call page lists documentary development, production and post-production among the open categories.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="National Film and Video Foundation / Netherlands Film Fund: Thuthuka Co-Development Fund",
        country_code="ZA",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=40_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="The 2025 call opened on 2 September 2025 and closed on 7 October 2025.",
        source_url="https://www.nfvf.co.za/national-film-and-video-foundation-netherlands-film-fund-thuthuka-co-development-fund-call-4/",
        source_description="NFVF - Thuthuka Co-Development Fund call",
        notes="Bilateral South Africa-Netherlands co-development scheme for feature-length documentary, live action and animated projects. "
              "The 2025 call supported one South African and one Dutch project each year at EUR 40,000 per project, with a maximum of EUR 6,000 for the producer fee plus overhead inside the grant.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Hot Docs Citizen Minutes Series 4",
        country_code="CA",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        eligible_stages=["development", "production", "post", "impact_campaign"],
        selection_mode="selective",
        operator_type="festival",
        application_status="closed",
        application_note="Applications for Series 4 opened on 21 January 2026 and closed on 19 March 2026.",
        source_url="https://hotdocs.ca/industry/film-funds/citizen-minutes",
        source_description="Hot Docs - Citizen Minutes Series 4",
        notes="Hot Docs commissions six 6-10 minute documentary shorts from emerging to mid-career Canadian filmmakers. "
              "The project includes funding and creative support, an online documentary lab, a 2027 Festival premiere, educational distribution through Docs for Schools, and an impact campaign.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    ...
    inc(
        name="Mexico FOCINE Produccion de Largometrajes Documentales 2026",
        country_code="MX",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=5_000_000,
        ...
        operator_type="government",
        application_status="closed",
        application_note="The 2026 documentary production registration opened on 2 January 2026 and closed on 30 January 2026 at 15:00 CST.",
        source_url="https://focine.imcine.gob.mx/focine/documental/",
        source_description="IMCINE - Produccion de largometrajes documentales FOCINE 2026",
        notes="Current IMCINE documentary production call under FOCINE. The 2026 documentary bases publish a maximum support amount of MXN 5,000,000 per project, divided between production and post-production as needed.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Mexico Estimulo a la Escritura de Guion y Desarrollo de Proyectos - Documental 2026",
        country_code="MX",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=200_000,
        ...
        operator_type="government",
        application_status="closed",
        application_note="The 2026 development call opened on 2 January 2026 and closed on 3 February 2026 at 15:00 CST.",
        source_url="https://www.imcine.gob.mx/estimulo.php",
        source_description="IMCINE - Estimulo a la Escritura de Guion y Desarrollo de Proyectos (Development) 2026",
        notes="IMCINE's 2026 development stimulus explicitly includes documentary long-form projects. The official bases publish a maximum support amount of MXN 200,000 for fiction, documentary or animation projects.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    ...
    inc(
        name="Chile Fondo Audiovisual 2026 - Largometraje Documental",
        country_code="CL",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=180_000_000,
        max_cap_currency="CLP",
        eligible_formats=["documentary"],
        eligible_stages=["preproduction", "production", "post"],
        selection_mode="selective",
        operator_type="government",
        application_status="closed",
        application_note="The 2026 call closed on 14 August 2025; the documentary feature modality publishes a maximum of CLP 180,000,000 per project.",
        source_url="https://www.fondosdecultura.cl/produccion-audiovisual-de-largometrajes-fondo-audiovisual-2026/",
        source_description="Chile Ministry of Cultures - Fondo Audiovisual 2026 / Largometraje documental",
        notes="Competitive Chilean audiovisual fund for feature-length documentary projects. "
              "The official 2026 bases specify CLP 720,000,000 available for documentary features and a maximum of CLP 180,000,000 per project, with documentary post-production and coproduction lines also listed separately.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Peru Concurso de Proyectos de Documental 2026",
        country_code="PE",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="government",
        application_status="open",
        application_note="The 2026 call opened on 6 April 2026 and closes on 27 May 2026.",
        source_url="https://estimuloseconomicos.cultura.gob.pe/2026/concursos/concurso-de-proyectos-de-documental",
        source_description="Peru Ministry of Culture - Concurso de proyectos de documental 2026",
        notes="Annual Peruvian documentary competition supporting development and production of national documentary feature projects. "
              "The public landing page does not publish a single headline project cap, but it clearly separates development and production modalities and provides the 2026 schedule and application documents.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Argentina Concurso de Largometrajes: Ficción y Documental - 1er Llamado 2026",
        country_code="AR",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=85_000,
        max_cap_currency="USD",
        eligible_formats=["feature_fiction", "documentary"],
        eligible_stages=["production"],
        selection_mode="selective",
        operator_type="government",
        application_status="closed",
        application_note="The 2026 call opened on 17 March 2026 and closed on 17 April 2026 at 14:00.",
        source_url="https://www.incaa.gob.ar/convocatorias/concurso-de-largometrajes-ficcion-y-documental-1-llamado-2026/",
        source_description="INCAA - Concurso de largometrajes: Ficción y Documental - 1° llamado 2026",
        notes="INCAA selected eight projects total in this call, including two documentary feature winners. Each documentary winner receives USD 85,000.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Argentina Concurso de Postproduccion 2026",
        country_code="AR",
        incentive_type="fund",
        rebate_percent=None,
        ...
        operator_type="government",
        application_status="closed",
        application_note="The 2026 call opened on 24 February 2026 and closed on 27 March 2026.",
        source_url="https://www.incaa.gob.ar/convocatorias/concurso-de-postproduccion-2026/",
        source_description="INCAA - Concurso de Postproduccion 2026",
        notes="INCAA's post-production competition supports fiction and documentary projects that have finished shooting. "
              "The 2026 call selected six projects total, including two documentary awards of USD 20,000 each.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="TAICCA Creative Content Development Program - Documentary",
        country_code="TW",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=2_000_000,
        max_cap_currency="TWD",
        min_total_budget=0,
        eligible_formats=["documentary", "series"],
        eligible_stages=["development"],
        selection_mode="selective",
        operator_type="government",
        application_status="unknown",
        application_note="The current program page publishes documentary development ceilings but does not show a single fixed annual deadline on the overview page.",
        source_url="https://taicca.tw/funds/support_plan/detail/1",
        source_description="TAICCA - Creative Content Development Program (Documentary category)",
        notes="Taiwan Creative Content Agency development fund for documentary and documentary-series projects. "
              "The current program page lists up to TWD 2 million or 10% of the total production budget for documentary categories, with support counted as an early-stage investment if the project advances to production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Tokyo International Content Production Support Program Grant",
        country_code="JP",
        region="Tokyo",
        incentive_type="grant",
        rebate_percent=50.0,
        ...
        operator_type="government",
        application_status="closed",
        application_note="The FY2025-2026 review schedule listed a final deadline of 30 January 2026; as of April 2026 no new call is posted.",
        source_url="https://www.locationbox.metro.tokyo.lg.jp/english/fund/",
        source_description="Tokyo Location Box - International Content Production Support Program Grant",
        clause_reference="Grant Ratios and Amount Limits; Application Review Schedule",
        notes="Selective Tokyo Metropolitan Government grant for location scouting and shooting of internationally released films and TV dramas. "
              "Location scouting is capped at JPY 1 million per group and shooting is capped at JPY 10 million per group, with up to 50% of eligible expenses covered; combined scouting and shooting may be eligible for up to two-thirds of eligible expenses. "
              "Animated films and short films are excluded, and projects must be carried by a Japanese incorporated corporation.",
        local_producer_required=True,
        stacking_allowed=False,
        last_verified="2026-04",
    ),
    inc(
        name="Fukuoka City Location Incentive Funding",
        country_code="JP",
        region="Fukuoka",
        incentive_type="grant",
        rebate_percent=50.0,
        max_cap_currency="JPY",
        min_total_budget=100_000_000,
        min_qualifying_spend=10_000_000,
        min_spend_currency="JPY",
        min_shoot_days=5,
        eligible_formats=["feature_fiction", "documentary", "series", "animation"],
        selection_mode="selective",
        operator_type="government",
        application_status="open",
        application_note="The FY2026 first round ran from 30 March to 30 April 2026, and the city says a second call is scheduled around August 2026.",
        source_url="https://www.city.fukuoka.lg.jp/keizai/contents/shisei/documents/kouhuyoukou.pdf",
        source_description="Fukuoka City Government - FY2026 Location Incentive Funding guidelines",
        notes="Selective Fukuoka City subsidy for live-action and animated productions shot or produced in Fukuoka City. "
              "The maximum subsidy rate is 50%, with separate expense caps for some line items including JPY 15,000 per person per night for accommodation and JPY 50,000 per person one-way for overseas travel. "
              "Production cost must be at least JPY 100 million and eligible local spend must be at least JPY 10 million.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
        name="Armenia Free Economic Zone Incentives",
        country_code="AM",
        incentive_type="tax_exemption",
        rebate_percent=None,
        max_cap_currency="AMD",
        source_url="https://www.gov.am/en/in-the-focus/item/6840/",
        source_description="Government of Armenia - First-Ever Free Economic Zone Out In Armenia",
        clause_reference="Free economic zone incentives for residents",
        notes="Armenia's FEZ framework offers resident companies tax benefits including a VAT holiday, exemption from import and export duties, and relief from profit tax and property tax. "
              "The government described the zone as a tool to attract foreign direct investment, boost exports, create jobs and support sustainable economic development.",
        local_producer_required=False,
        application_status="open",
        stacking_allowed=True,
        last_verified="2026-04",
    ...
    inc(
        name="Azerbaijan Investment Promotion Mechanism",
        country_code="AZ",
        incentive_type="tax_exemption",
        rebate_percent=50.0,
        max_cap_currency="AZN",
        source_url="https://www.economy.gov.az/en/page/itm",
        source_description="Ministry of Economy of Azerbaijan - Investment promotion mechanism",
        clause_reference="Presidential Decrees Nos. 745, 877 and 1913; tax and customs incentives",
        notes="Azerbaijan's investment promotion certificate mechanism gives eligible projects 7 years of incentives, including a 50% reduction in profit or income tax, full exemption from land and property taxes, and exemption from customs duties and VAT on imported machinery, technological equipment and installations. "
              "The ministry says the mechanism is currently extended to January 1, 2029 for qualifying strategic project categories.",
        local_producer_required=False,
        application_status="open",
        stacking_allowed=False,
        last_verified="2026-04",
    ...
    inc(
        name="Belarus Preferential Investment Project Framework",
        country_code="BY",
        incentive_type="tax_exemption",
        rebate_percent=None,
        max_cap_currency="BYN",
        source_url="https://investmentpolicy.unctad.org/investment-laws/laws/542/belarus-investment-law",
        source_description="UNCTAD Investment Laws Navigator - Belarus Investment Law",
        clause_reference="Articles 6 and 13; preferential investment projects",
        notes="Belarus law provides preferential investment projects for priority sectors and allows benefits and preferences, including budget-transfer support for qualifying projects and infrastructure-cost compensation in designated regions. "
              "The revised framework also includes a stabilization clause intended to protect investors from unfavorable tax changes for five years.",
        local_producer_required=False,
        application_status="unknown",
        stacking_allowed=True,
        last_verified="2026-04",
    ...
    inc(
        name="AFAC Documentary Film Program",
        country_code="LB",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=50_000,
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2026 open call opened on 2 February 2026 and closed on 2 April 2026.",
        source_url="https://www.arabculturefund.org/Programs/7",
        source_description="AFAC - Documentary Film Program",
        notes="The AFAC Documentary Film program supports creative documentary films in the Arab region. "
              "It offers annual grants of up to USD 10,000 for development, up to USD 50,000 for feature-length production, up to USD 20,000 for short and medium-length production, and up to USD 25,000 for feature-length post-production or USD 10,000 for short and medium-length post-production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Asian Network of Documentary (AND) Fund",
        country_code="KR",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=20_000_000,
        ...
        operator_type="festival",
        application_status="unknown",
        application_note="The public ACF pages show the 2026 call for submissions and an AND Fund guideline PDF, but the current deadline is not visible on the overview page.",
        source_url="https://acf.biff.kr/eng/",
        source_description="Asian Cinema Fund - Asian Network of Documentary (AND) Fund",
        notes="Busan International Film Festival's documentary completion fund for Asian feature-length documentaries aimed at theatrical release. "
              "The publicly available guideline PDF states a cash grant of up to 20 million KRW and eligibility for projects at any stage of production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="foundation",
        application_status="unknown",
        application_note="The public site describes an ongoing funding and mentoring platform but does not publish a single universal open-call deadline on the overview page.",
        source_url="https://docsupfunds.com/about-us",
        source_description="Docs Up Fund - About us",
        notes="European and international human-rights documentary fund that supports projects at the idea, production, rough-cut and impact-campaign phases. "
              "The official site emphasizes creative, politically engaged documentaries and does not publish a standard per-project cap on the overview page.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Docubox Funding",
        country_code="KE",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="foundation",
        application_status="unknown",
        application_note="Docubox says its funding cycle is irregular and that filmmakers should watch its social channels for the next call.",
        source_url="https://mydocubox.org/funding/",
        source_description="Docubox - Funding page",
        notes="East African documentary film fund with irregular calls for feature and short documentary projects. "
              "The official funding page says applicants generally need some filmed material or a trailer and that unsolicited proposals have little chance when no call is open.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Documentary Africa RRI Startup Grants",
        country_code="KE",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=10_000,
        ...
        operator_type="foundation",
        application_status="open",
        application_note="The current RRI call lists a deadline of 13 April 2026 and support for impact campaigns to run between May 2026 and March 2027.",
        source_url="https://documentaryafrica.org/rri-real-reel-impact/",
        source_description="Documentary Africa - Real Reel Impact program",
        notes="Current Documentary Africa impact grant for African documentary projects ready to launch a structured social-impact campaign. "
              "The official page says selected projects receive startup funding of up to USD 10,000 and must be late-stage production or already premiered after October 2025.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The public page currently lists the 2025 grantees and does not publish a new open call as of 17 April 2026.",
        source_url="https://documentaryafrica.org/ntd-doc-series/",
        source_description="Documentary Africa - NTD Doc Series",
        notes="Documentary Africa program in partnership with The End Fund supporting six short documentary films on health-related stories from communities affected by Neglected Tropical Diseases. "
              "The public program page lists the 2025 grantees but does not publish a standard per-project grant cap.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The current public page reflects the 2025 grant cycle; the next open call was not posted on the page as of 17 April 2026.",
        source_url="https://sgiff.com/sgiff-film-fund/",
        source_description="SGIFF Film Fund - SEA-DOC Grant",
        notes="Southeast Asian documentary grant under the SGIFF Film Fund. "
              "The official page says the fund awards four documentaries annually, with three production grants of SGD 30,000 each and one post-production grant of SGD 20,000.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Catapult Film Fund Development Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="foundation",
        application_status="open",
        application_note="The 2026 Catapult Development Grant is listed on the current application manager.",
        source_url="https://catapultfilmfund.submittable.com/submit",
        source_description="Catapult Film Fund - 2026 Development Grant application manager",
        notes="Catapult provides nonfiction filmmakers with early-stage funding and mentorship to launch story-driven documentary projects. "
              "The current application manager lists the 2026 Catapult Development Grant; the official partner page describes the program as supporting early-stage materials that can unlock critical production funding.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Who Let The Docs Out - Coexistence Documentary Fund",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=50_000,
        max_cap_currency="USD",
        eligible_formats=["documentary"],
        eligible_stages=["research", "development", "production", "post", "impact_campaign"],
        selection_mode="selective",
        operator_type="mixed",
        application_status="closed",
        application_note="The 2026 summer grant cycle opens in early June; the spring cycle closed on 16 March 2026.",
        source_url="https://www.docsout.org/grants",
        source_description="Who Let The Docs Out - Grants",
        notes="Global documentary grants for projects challenging systems of consumption and climate breakdown. "
              "The current grant page lists awards for research (USD 8,000), development/sizzle (USD 15,000), production (USD 50,000), post-production (USD 50,000), and impact campaigns (USD 30,000) in the 2026 cycle.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Who Let The Docs Out - Automation & Humanity Documentary Fund",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=50_000,
    ...
    inc(
        name="Sundance Institute | Sandbox Fund",
        country_code="US",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=100_000,
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2026 Spring Cycle closed on 13 April 2026; Sundance says the fund runs two cycles per year and the next cycle will be announced later in 2026.",
        source_url="https://www.sundance.org/sandbox-fund/",
        source_description="Sundance Institute | Sandbox Fund",
        notes="Worldwide support for feature-length nonfiction projects exploring the link between science and culture. "
              "The current fund page lists average grants of up to USD 40,000 for development and up to USD 100,000 for production or post-production.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="Sundance Institute Documentary Short Fund",
        country_code="US",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The public page says the fund is currently closed and operates as a biennial opportunity; no current open-call date is posted.",
        source_url="https://www.sundance.org/documentary-short-fund/",
        source_description="Sundance Institute Documentary Short Fund",
        notes="Periodic funding opportunity for short documentary work. "
              "The current public page does not publish a fixed award cap and says priorities and eligibility can change with each open call.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="SFFILM Catapult Documentary Fellowship",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=10_000,
        ...
        operator_type="mixed",
        application_status="closed",
        application_note="SFFILM announced the inaugural fellowships on 26 March 2026; the current round is closed and future rounds have not yet been posted.",
        source_url="https://sffilm.org/press-releases/sffilm-expands-documentary-support-with-announcement-of-inaugural-sffilm-catapult-documentary-fellowships-and-renewal-of-ampas-doc-talks-program/",
        source_description="SFFILM - Catapult Documentary Fellowship announcement",
        notes="Early-development documentary fellowship created with Catapult Film Fund. "
              "Selected fellows receive a USD 10,000 cash grant, a two-month residency at FilmHouse, and strategic consultation from SFFILM and Catapult staff plus documentary mentors.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="ITVS Diversity Development Fund",
        country_code="US",
        incentive_type="fund",
        rebate_percent=None,
        eligible_formats=["documentary"],
        ...
        operator_type="government",
        application_status="open",
        application_note="The current ITVS funding portal lists the Diversity Development Fund as open.",
        source_url="https://forms.itvs.org/",
        source_description="ITVS documentary funding portal",
        notes="ITVS' Diversity Development Fund supports documentary projects from producers of color at the research and development stage. "
              "The current funding portal lists the fund as open; public ITVS guidance and archived official posts describe it as seed funding for single documentary programs for public television.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        ...
        operator_type="foundation",
        application_status="open",
        application_note="The 2026 deadlines are Wednesday 22 April 2026 and Wednesday 19 August 2026.",
        source_url="https://www.rogersgroupoffunds.com/fund-my-project/documentary-fund/",
        source_description="Rogers Group of Funds - Documentary Fund",
        notes="Canada's long-running documentary financing program for independent producers. "
              "The 2026 guidelines state the fund supports Canadian documentary production and set the per-project support level at up to CAD 100,000, with decisions made twice per year.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Berkeley Film Foundation Documentary Grant Program",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=25_000,
        max_cap_currency="USD",
        eligible_formats=["documentary"],
        eligible_stages=["production", "post", "distribution"],
        selection_mode="selective",
        operator_type="foundation",
        application_status="open",
        application_note="The 2026 documentary application window opened on 16 March 2026 and closes on 13 April 2026 at 11:59 p.m. PST.",
        source_url="https://berkeleyfilmfoundation.org/documentary-grant-program",
        source_description="The Berkeley Film Foundation - Documentary Grant Program",
        notes="East Bay documentary production fund for filmmakers who live in Berkeley, Emeryville, Albany, El Cerrito, Richmond, Alameda or Oakland. "
              "The 2026 program awards competitive grants ranging from USD 5,000 to USD 25,000 for documentary projects in production, post-production, or distribution.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
        name="Berkeley Film Foundation Student Documentary Grant",
        country_code="US",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=5_000,
        ...
        operator_type="foundation",
        application_status="open",
        application_note="The 2026 student grant deadline is 13 April 2026 at 11:59 p.m. PST.",
        source_url="https://berkeleyfilmfoundation.org/student-grants",
        source_description="The Berkeley Film Foundation - Student Grants",
        notes="Student documentary grants for undergraduate, graduate, and continuing-education filmmakers actively working on documentary projects. "
              "The 2026 program offers grants of up to USD 5,000 for production, post-production, or distribution expenses.",
        local_producer_required=True,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="One World Media Climate and Labour Film Grant",
        country_code="GB",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=20_000,
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2024 cycle is complete; the deadline was 1 September 2024 and the film was completed by June 2025.",
        source_url="https://oneworldmedia.org.uk/fellowship/apply/climate-and-labour-film-grant/",
        source_description="One World Media - Climate and Labour Film Grant",
        notes="Short documentary grant for global-south filmmakers exploring climate change and labour. "
              "The official page states the selected filmmaker received up to GBP 20,000, an executive producer, and FT distribution support for a film under 25 minutes.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="One World Media Global Health Film Grant",
        country_code="GB",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=20_000,
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2025 cycle is complete; the deadline was 20 August 2025 and final delivery is due in June 2026.",
        source_url="https://oneworldmedia.org.uk/projects/global-health-film-grant/",
        source_description="One World Media - Global Health Film Grant",
        notes="Short documentary grant for experienced global-south filmmakers exploring underreported health stories in the Global South. "
              "The official page states the selected filmmaker receives up to GBP 20,000, mentoring, an executive producer, and FT distribution support for a film under 25 minutes.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
        name="One World Media Amazon Film Grant",
        country_code="GB",
        incentive_type="grant",
        rebate_percent=None,
        max_cap_amount=5_000,
        ...
        operator_type="foundation",
        application_status="closed",
        application_note="The 2025 cycle is complete; One World Media announced the winner on 28 November 2025.",
        source_url="https://oneworldmedia.org.uk/projects/amazon-film-grant/",
        source_description="One World Media - Amazon Film Grant",
        notes="Short documentary grant for storytellers reporting on the Amazon region in partnership with Mongabay. "
              "The official page states the selected applicant receives up to USD 5,000, an executive producer, mentoring, and a film under 10 minutes.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
    ...
    inc(
        name="Nordisk Film & TV Fond Documentary Top Financing",
        country_code="NO",
        incentive_type="fund",
        rebate_percent=None,
        max_cap_amount=1_000_000,
        ...
        operator_type="foundation",
        application_status="rolling",
        application_note="Applications are evaluated continuously via the fund portal; the 2025 guidelines note a new documentary deadline regime from 2026.",
        source_url="https://nordiskfilmogtvfond.com/assets/download/Guidelines_2025_English.pdf",
        source_description="Nordisk Film & TV Fond - Guidelines 2025",
        notes="Nordic top financing for creative documentaries with significant audience potential in the Nordic region and secondarily internationally. "
              "The current funding policy says documentary support is normally around 9% of the production budget and not usually higher than NOK 1,000,000.",
        local_producer_required=False,
        last_verified="2026-04",
    ),
    inc(
